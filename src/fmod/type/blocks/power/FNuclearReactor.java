package fmod.type.blocks.power;
...
public class FNuclearReactor extends PowerGenerator {
    ...
    public Item fuelItem = FItems.enrichedThorium;
    ...
    public FNuclearReactor(String name){
        super(name);
        itemCapacity = 30;
        liquidCapacity = 40;
        hasItems = true;
