package persea.world.blocks.power;
...
public class PerseaReactor extends PowerGenerator {
    ...
    public Item fuelItem = PerseaItems.enrichedThorium;
    ...
    public PerseaReactor(String name){
        super(name);
        itemCapacity = 30;
        liquidCapacity = 40;
        hasItems = true;
